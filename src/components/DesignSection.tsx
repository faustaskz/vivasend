  ...
  return (
    <section className="py-24 px-[5%] bg-bg">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        {/* Visual – left */}
        <div className="bg-bg-3 border border-vs-border2 rounded-2xl p-7 order-2 lg:order-1">
          ...
          <div className="bg-bg rounded-xl overflow-hidden">
            ...
            <div className="p-5">
              ...
              <p className="text-[13px] text-vs-muted leading-relaxed mb-4">
                Esate sveiki atvykę į VivaSend platformą. Pradėkite savo
                pirmą kampaniją jau šiandien ir pasiekite klientus
                efektyviau nei bet kada.
              </p>
              <div className="bg-orange text-white text-center py-2.5 rounded-lg text-[13px] font-medium">
                Pradėti nemokamai →
              </div>
            </div>
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-[16px] text-vs-muted leading-[1.7] mb-6">
            Profesionalaus dizaino laiškai nebereikalauja dizainerio.
            Naudokitės patogiu „drag & drop" redaktoriumi ir šimtais
            paruoštų šablonų.
          </p>
