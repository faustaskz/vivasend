  ...
  return (
    <footer className="bg-bg-2 border-t border-vs-border pt-16 pb-8 px-[5%]">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-[14px] text-vs-muted leading-relaxed max-w-[220px]">
              VivaSend – galingas ir įnovatyvus naujienlaiškių įrankis Jūsų verslui.
          ...
          {Object.entries(LINKS).map(([col, links]) => (
            <div key={col}>
              <h4 className="text-[12px] font-semibold uppercase tracking-[0.08em] text-vs-muted mb-4">
                {col}
              </h4>
              <ul className="flex flex-col gap-2.5">
                {links.map((l) => (
                  <li key={l.label}>
                    <a
                      href={l.href}
                      className="text-[14px] text-vs-muted hover:text-vs-text transition-colors"
                    >
                      {l.label}
                    </a>
                  </li>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-vs-border gap-3 text-[13px] text-vs-faint">
